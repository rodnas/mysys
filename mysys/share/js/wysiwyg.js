...
// Images Directory
imagesDir = "../backend/img/editor/";

// CSS Directory
cssDir = "../backend/css/";

// Popups Directory
popupsDir = "../share/js/popups/";
...
function generate_wysiwyg(textareaID,wysiwygWidth,wysiwygHeight) {
  ...
  toolbar2 += '<td>&nbsp;</td></tr></table>';  
	...
	var iframe = '<table cellpadding="0" cellspacing="0" border="0" style="width:' + wysiwygWidth + 'px; height:' + wysiwygHeight + 'px;border: 1px solid gray;"><tr><td valign="top">\n'
